...
<?php
    if(!empty($_SESSION['needy_user'])){
        ...
        if($_SESSION['needy_usetype'] != "Admin"){
            header("location: ../");
        }
    }else{
        header("location: ../");
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.php"><img class="main-logo" src="img/logo/logo123.png" alt="NEEDY-OSFA" /></a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="../feeds.php"><span class="icon nalika-settings author-log-ic"></span> Your Products</a>
                                                        </li>
                                                        <li><a href="#"><span class="icon nalika-settings author-log-ic"></span> Settings</a>
                                                        </li>
                                                        <li><a href="logout.php?Cl2QIB4DD3nA=true&Cl2QIB4DnA=false"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
