...
<?php
        while($row = mysqli_fetch_assoc($history)){
            ...
            $details  = substr($row['product_content'],0,100);
...
?>
    ...
    <tr>
        ...
        <td><a href="<?php echo $web2; ?>" class="nav-link">Website</a></td>
...
?>
    <div class="pt-5 text-center">
        <h2 class="lead">Currently you are not providing any products</h2>
        <h3 class="lead">Want to add products.. ???<a href="add.php?ref=history">Add products </a> here... </h3>
    </div>
<?php
        }
?>